...
const ProfileDetails = () => {
  ...
  const getTextColorClass = (color) => {
      switch (color) {
          ...
          default: return 'text-gray-600'; // Fallback
      }
  };
    ...
    >
      ...
      <div className="p-4 md:p-6">
          ...
          <p className="text-sm md:text-base leading-relaxed text-gray-700">
            ...
            {Object.keys(roleDescriptions).map((role, index) => (
              <span key={index} className="group relative inline-block mx-1">
                {/* Trigger Text */}
                <span
                  className="inline-block cursor-pointer font-medium text-blue-600 hover:text-blue-800 transition-colors duration-300 border-b border-dotted border-blue-400 hover:border-blue-600"
                >
                  {role}
                </span>
                ...
                <span className="invisible absolute z-50 max-w-xs p-4 bg-gray-900 text-white text-sm rounded-lg
                              ...
                              pointer-events-none">
                  {/* Triangle */}
                  <span className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-0 h-0
                                border-l-8 border-r-8 border-t-8
                                border-l-transparent border-r-transparent border-t-gray-900"></span>
        ...
        <div className="mb-6 md:mb-8 p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          <h3 className="text-base md:text-lg font-bold mb-3 text-gray-800 flex items-center">
             <span className="inline-block w-8 h-8 flex items-center justify-center bg-blue-600 text-white rounded-full mr-3 flex-shrink-0 shadow">
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-5 h-5"> <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
             </span>
             My Strategy
           </h3>
        ...
        <div className="mb-6 md:mb-8 p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
           <h3 className="text-base md:text-lg font-bold mb-3 text-gray-800 flex items-center">
             <span className="inline-block w-8 h-8 flex items-center justify-center bg-purple-600 text-white rounded-full mr-3 flex-shrink-0 shadow">
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>
             </span>
             My Philosophy
           </h3>
           <p className="text-sm md:text-base text-gray-700 leading-relaxed">
             ...
             learn new approaches to problem-solving that creates automation.
           </p>
           <blockquote className="mt-3 pl-4 border-l-4 border-purple-200 italic text-gray-600 text-sm md:text-base">
             Thank you for taking the time to read my about section. It's Who I Am.
           </blockquote>
        </div>
        ...
        <div className="mb-6 md:mb-8 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-blue-100">
          <h3 className="text-base md:text-lg font-bold mb-3 text-gray-800 flex items-center">
            <span className="inline-block w-8 h-8 flex items-center justify-center bg-indigo-600 text-white rounded-full mr-3 flex-shrink-0 shadow">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
            </span>
          ...
          <div className="bg-white p-3 rounded-lg mb-3 shadow-inner">
            <div className="text-gray-700 flex flex-wrap items-center justify-center text-center gap-2">
              <span className="inline-block px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs sm:text-sm">🌟 使命 🌟 Make the world a better place</span>
              <span className="inline-block px-2 py-1 bg-purple-100 text-purple-800 rounded-full text-xs sm:text-sm">🌟 想象 🌟 A model person who provides quality services</span>
              <span className="inline-block px-2 py-1 bg-indigo-100 text-indigo-800 rounded-full text-xs sm:text-sm">🌟 座右铭 🌟 Applying Concepts <span className="inline-block animate-spin text-[1em]">⚙️</span> to solve problems + Moving On + Spread Joy</span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 md:mb-8 p-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-100">
          ...
          <div className="relative overflow-hidden" style={{ minHeight: windowWidth < 640 ? "280px" : "220px" }}>
            {testimonials.map((testimonial, index) => {
              ...
              if (testimonial.color === 'blue') {
                borderColorClass = 'border-blue-400'; quoteColorClass = 'text-blue-400'; badgeBgColorClass = 'bg-blue-100 text-blue-700';
              } else if (testimonial.color === 'purple') {
                borderColorClass = 'border-purple-400'; quoteColorClass = 'text-purple-400'; badgeBgColorClass = 'bg-purple-100 text-purple-700';
              } else if (testimonial.color === 'indigo') {
                borderColorClass = 'border-indigo-400'; quoteColorClass = 'text-indigo-400'; badgeBgColorClass = 'bg-indigo-100 text-indigo-700';
              } else if (testimonial.color === 'green') {
                borderColorClass = 'border-green-400'; quoteColorClass = 'text-green-400'; badgeBgColorClass = 'bg-green-100 text-green-700';
              }
              ...
              return (
                ...
                >
                  ...
                  <div className={`bg-white p-3 sm:p-4 rounded-lg shadow-sm border-l-4 ${borderColorClass} transition-all duration-300 ${hoveredTestimonial === index ? "shadow-lg transform scale-[1.01]" : ""}`}>
                    <div className="mb-3 flex items-start">
                      <FaQuoteLeft className={`${quoteColorClass} text-opacity-30 text-3xl mr-2 mt-1 hidden sm:block`} />
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                      <div className="mb-1 sm:mb-0">
                        ...
                        <p className={`${getTextColorClass(testimonial.color)} text-xs sm:text-sm`}>
                          {testimonial.position || `On my ${testimonial.focus}`}
                        </p>
                      </div>
                      {/* Pagination Badge */}
                      <span className={`px-2 py-0.5 text-[10px] sm:text-xs rounded-full ${badgeBgColorClass} self-start sm:self-auto mt-1 sm:mt-0`}>
        ...
        <div className="mt-6 md:mt-8 text-center">
           ...
           <div className="flex justify-center space-x-3 sm:space-x-4 md:space-x-6 mt-3">
             {/* LinkedIn */}
             <a href="https://www.linkedin.com/in/bruce-minanga-768a55240/" target="_blank" rel="noopener noreferrer" className="transform transition-transform hover:scale-110 group flex flex-col items-center">
               ...
               <span className="block mt-1 text-[10px] sm:text-xs md:text-sm text-gray-600 group-hover:text-blue-600 transition-colors duration-300">LinkedIn</span>
             </a>
              {/* GitHub */}
              <a href="https://github.com/bruceminanga" target="_blank" rel="noopener noreferrer" className="transform transition-transform hover:scale-110 group flex flex-col items-center">
                ...
                <span className="block mt-1 text-[10px] sm:text-xs md:text-sm text-gray-600 group-hover:text-gray-800 transition-colors duration-300">GitHub</span>
              </a>
              {/* HackerRank */}
              <a href="https://www.hackerrank.com/profile/bruceminanga" target="_blank" rel="noopener noreferrer" className="transform transition-transform hover:scale-110 group flex flex-col items-center">
                ...
                <span className="block mt-1 text-[10px] sm:text-xs md:text-sm text-gray-600 group-hover:text-green-600 transition-colors duration-300">HackerRank</span>
              </a>
           </div>
         </div>
      </div> {/* End of overall padding div */}
